...
# Load and preprocess the data
    ...
    user_options = all_data_3 ['user_id'].unique()[:50]
    selected_user_id = st.selectbox('Select User ID:', user_options)
    result=all_data_3[['user_id','user','product_id','product_name','sub_category','link','image','price','description']][all_data_3['user_id']==selected_user_id]
    st.write("Here are the top results:")
